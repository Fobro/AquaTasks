...
extern void *mono_aot_module_AquaTasks_NET_Source_info;
...
void xamarin_register_modules_impl ()
{
	...
	mono_aot_register_module (mono_aot_module_AquaTasks_NET_Source_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "AquaTasks_NET_Source.dll";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
